...
//	}
	...
	public ResponseEntity<Response> listPureConfig(@RequestParam("authUserId") String userId,  @RequestParam("siteKey")  String siteKey) {
	...
	public ResponseEntity<Response> getKeyList(@RequestParam("authUserId") String userId, @RequestParam("siteKey")  String siteKey) {
