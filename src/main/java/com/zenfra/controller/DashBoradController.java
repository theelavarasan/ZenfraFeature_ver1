...
public class DashBoradController {
	...
	@GetMapping("/layout")
	public ResponseEntity<?> getDashLayout(@RequestParam String siteKey, @RequestParam String userId) {
	...
	public ResponseEntity<?> deleteDashboardChart(@RequestParam String chartId, @RequestParam String siteKey,
	...
	public ResponseEntity<?> saveDashboardLayout(@RequestBody DashboardUserCustomization dash) {

		ResponseModel_v2 responseModel = new ResponseModel_v2();

		try {

			DashboardUserCustomization dashExit = dashService.getDashUserCusBySiteKeyAndUserId(dash.getSiteKey(),
					dash.getUserId());
	...
	public ResponseEntity<?> updateDashboardLayout(@RequestBody DashboardUserCustomization dash) {
	...
	public ResponseEntity<?> saveDashboardChart(@RequestBody DashBoardCharts dash) {
		...
		try {
			...
			if (dash.getChartList() != null && !dash.getChartList().isEmpty()) {
				for (String c : dash.getChartList()) {
					...
					DashBoardCharts existObj = dashService.getDashChartsByUserIdSiteKey(dash.getUserId(),
							dash.getSiteKey(), c);
					if (existObj != null) {
	...
	public ResponseEntity<?> updateDashboardChart(@RequestBody DashBoardCharts dash) {
	...
	public ResponseEntity<?> getDashboardChartDetails(@RequestBody DashboardInputModel dashboardInputModel,
		...
		try {
			 ...
			 * dashService.getProjectSummary(dashboardInputModel,token); }else {
	...
	public ResponseEntity<?> getChatForFavMenu(@RequestParam String favouriteId, @RequestParam String userId,
			@RequestParam String siteKey, @RequestParam String analyticsType) {
	...
	public ResponseEntity<?> saveDashboardChartDetails(@RequestBody DashboardChartDetails dash,
		...
		try {
			 ...
			 * if(chart==null) { ChartModel_v2 chartTemp=new ChartModel_v2();
			 * chartTemp.setChartId(dash.getChartDetails()); chartTemp.setActive(true);
			 * //chartTemp.set }
			 */

			DashboardChartDetails exitObject = dashService.getDashboardChartDetailsBySiteKey(dash.getSiteKey(),
					dash.getChartId());
	...
	public ResponseEntity<?> updateDashboardChartDetails(@RequestBody DashboardChartDetails dash) {
