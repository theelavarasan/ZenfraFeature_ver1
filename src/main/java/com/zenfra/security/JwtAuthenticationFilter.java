...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest req, HttpServletResponse res, FilterChain chain)
		...
		// System.out.println("!!!!! Constants.HEADER_STRING: " +
		...
		// System.out.println("Request URL path="+path+": Request content type
		// ="+contentType);

		/*
		 * if(path!=null && path.contains("/auth")) { return; }
		 */
		...
		if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
			...
			if (userObject != null && !userObject.isEmpty()) {
				...
				UsernamePasswordAuthenticationToken authentication = new UsernamePasswordAuthenticationToken(userObject,
