...
public class ColumnVO implements Serializable {
    ...
    public ColumnVO(String id, String displayName, String field, String aggFunc) {
        this.id = id.replaceAll("\\s+", "_").toLowerCase();
        this.displayName = displayName.replaceAll("\\s+", "_").toLowerCase();
        this.field = field.replaceAll("\\s+", "_").toLowerCase();
    ...
    public String toString() {
        return id + " : "+ displayName + " : " + field +" : " + aggFunc;
    }
}